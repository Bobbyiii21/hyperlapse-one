...
const Navbar: React.FC = () => {
  ...
  return (
    <div className={`fixed w-full top-0 bg-black text-white p-[10px] ${isOpen ? 'h-[100vh]' : 'h-auto'}`}>
      <button className="md:hidden float-right block px-2 mt-1" onClick={() => setIsOpen(!isOpen)}>
